...
CUSTs = ["cust", "CUST", "中華科技大學", "中華科大", "中華"]
CCTs = ["cct", "CCT", "臺北基督學院", "台北基督學院", "北基督"]
HDUTs = ["hdut", "HDUT", "宏國德霖科技大學", "宏國德霖科大", "宏國德霖"]
CNUs = ["cnu", "CNU", "嘉南藥理大學", "嘉藥"]

NTUAs = ["NTUA", "ntua", "國立臺灣藝術大學", "國立台灣藝術大學",
         "臺灣藝術大學", "台灣藝術大學", "臺藝大", "台藝大", "臺藝", "台藝"]
UTaipeis = ["UTaipei", "臺北市立大學", "台北市立大學", "臺北市大", "台北市大", "北市大"]
NTUTs = ["ntut", "NTUT", "國立臺北科技大學", "國立台北科技大學",
         "臺北科技大學", "台北科技大學", "臺北科大", "台北科大", "北科大", "北科"]
TMUs = ["tmu", "TMU", "臺北醫學大學", "台北醫學大學", "北醫"]
NTUBs = ["ntub", "NTUB", "國立臺北商業大學", "國立台北商業大學",
         "臺北商業大學", "台北商業大學", "臺北商大", "台北商大", "北商大", "北商"]
HCLIBs = ["hclib", "HCLIB", "新竹市文化局圖書館", "新竹市立圖書館", "新竹市圖書館", "新竹市圖", "竹市圖"]
HCPLs = ["hcpl", "HCPL", "新竹縣公共圖書館", "新竹縣立圖書館", "新竹縣圖書館", "新竹縣圖", "竹縣圖"]
Miaolis = ["Miaoli", "miaoli", "苗栗縣立圖書館",
           "苗栗縣公共圖書館", "苗栗縣圖書館", "苗栗縣圖", "苗栗圖書館", "苗栗", "苗圖"]
...
NTCUs = ["ntcu", "NTCU", "國立臺中教育大學",
         "國立台中教育大學", "臺中教育大學", "台中教育大學", "中教大", "中教"]
NTUSs = ["ntus", "NTUS", "國立臺灣體育運動大學", "國立台灣體育運動大學",
         "臺灣體育運動大學", "台灣體育運動大學", "臺體大", "台體大", "臺體", "台體"]
...
NCKUs = ["ncku", "NCKU", "國立成功大學", "成功大學", "成大", "成功"]

NTOUs = ["ntou", "NTOU", "國立臺灣海洋大學", "國立台灣海洋大學", "海大", "海洋大學"]
NTNUs = ["ntnu", "NTNU", "國立臺灣師範大學", "國立台灣師範大學",
         "臺灣師範大學", "台灣師範大學", "台師大", "臺師大", "台師", "臺師"]
NTUSTs = ["ntust", "NTUST", "國立臺灣科技大學", "國立台灣科技大學", "臺灣科技大學",
          "台灣科技大學", "臺灣科大", "台灣科大", "台科大", "臺科大", "臺科", "台科"]
...
TSUs = ["tsu", "TSU", "臺灣首府大學", "台灣首府大學", "首府大學", "首府大", "台首大", "臺首大"]
...
CJCs = ["cjc", "CJC", "崇仁醫護管理專科學校", "崇仁醫專", "崇仁醫護", "崇仁護專", "崇仁專校"]
...
TNUAs = ["TNUA", "tnua", "國立臺北藝術大學", "國立台北藝術大學",
         "臺北藝術大學", "台北藝術大學", "臺北藝大", "台北藝大", "北藝大", "北藝"]
NCUTs = ["ncut", "NCUT", "國立勤益科技大學", "勤益科技大學", "勤益科大", "勤科大", "勤科", "勤益"]
ISUs = ["isu", "ISU", "義守大學", "義守", "義大"]
CSMUs = ["csmu", "CSMU", "中山醫學大學", "中山醫大", "中山醫"]
NHRIs = ["nhri", "NHRI", "國家衛生研究院", "國衛院"]

TPCUs = ["tpcu", "TPCU", "臺北城市科技大學", "台北城市科技大學",
         "城市科技大學", "北城科大", "城市科大", "城科大", "城科", "城大", "北城"]
NTPUs = ["ntpu", "NTPU", "國立臺北大學", "國立台北大學",
         "臺北大學", "台北大學", "臺北大", "台北大", "北大"]
TMUSTs = ["tmust", "TMUST", "德明財經科技大學", "德明科大", "德明"]
LHUs = ["lhu", "LHU", "龍華科技大學", "龍華科大", "龍華"]
TCPLs = ["tcpl", "TCPL", "臺中市立圖書館", "台中市立圖書館", "臺中市圖書館",
         "台中市圖書館", "臺中圖書館", "台中圖書館", "臺中市圖", "台中市圖", "中圖"]
CMUs = ["cmu", "CMU", "中國醫藥大學", "中國醫"]
Asias = ["asia", "Asia", "亞洲大學", "亞洲大", "亞洲", "亞洲大"]
TNPLs = ["tnpl", "TNPL", "臺南市立圖書館", "台南市立圖書館",
         "臺南市圖書館", "台南市圖書館", "臺南市圖", "台南市圖", "南圖"]
TCUs = ["tcu", "TCU", "慈濟大學", "慈濟", "慈大"]
NPUs = ["npu", "NPU", "國立澎湖科技大學", "澎湖科技大學", "澎湖科大", "澎科大", "澎科"]

KLCCABs = ["klccab", "KLCCAB", "kllib", "KLLIB",
           "基隆市公共圖書館", "基隆市圖", "基隆市圖書館", "基隆圖書館"]
NUTCs = ["nutc", "NUTC", "國立臺中科技大學", "國立台中科技大學",
         "臺中科技大學", "台中科技大學", "臺中科大", "台中科大", "中科大", "中科"]
TNNUAs = ["tnnua", "TNNUA", "國立臺南藝術大學", "國立台南藝術大學",
          "臺南藝術大學", "台南藝術大學", "臺南藝大", "台南藝大", "南藝大", "南藝"]
NTCPLs = ["ntcpl", "NTCPL", "南投縣政府文化局圖書館",
          "南投縣公共圖書館", "南投縣圖書館", "南投圖書館" "南投縣圖", "南投圖"]
NCLs = ["ncl", "NCL", "國家圖書館", "國圖"]
SHUs = ["shu", "SHU", "世新大學", "世新"]
TUMTs = ["tumt", "TUMT", "臺北海洋科技大學", "台北海洋科技大學", "北海科大"]
MITUSTs = ["mitust", "MITUST", "敏實科技大學", "敏實科大", "敏實"]

NTUs = ["ntu", "NTU", "國立臺灣大學", "國立台灣大學", "臺灣大學", "台灣大學", "臺大", "台大", "公館"]
...
NCNUs = ["ncnu", "NCNU", "國立暨南國際大學", "暨南國際大學", "暨南大學", "暨大", "暨南"]
NUTNs = ["nutn", "NUTN", "國立臺南大學", "國立台南大學",
         "臺南大學", "台南大學", "臺南大", "台南大", "南大"]
NTCHs = ["ntch", "NTCH", "國家兩廳院", "兩廳院"]
NMPs = ["nmp", "NMP", "國立臺灣史前文化博物館", "國立台灣史前文化博物館",
        "臺灣史前文化博物館", "台灣史前文化博物館", "史前文化博物館", "史前館"]
...
def test1(event):
    ...
    city_name = ["台北市", "新北市", "基隆市", "桃園市", "苗栗縣", "新竹縣", "新竹市", "台中市", "彰化縣",
                 "南投縣", "雲林縣", "嘉義市", "台南市", "高雄市", "屏東縣", "宜蘭縣", "花蓮縣", "台東縣", "金門縣, 連江縣, 澎湖縣"]
    city_name_dic = {**n_dict, **c_dict, **s_dict, **e_dict}
    city_region_dict = dict(
    ...
    # ----------------不同區域的介面設定-----------------
        ...
        # 讀需要的json資料
        f_region = open(
            'json_files_for_robot/json_for_app.json', encoding="utf8")
